...
class Interceptor extends \Sm\Deals\Block\Deals implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\ResourceConnection $resourceConnection, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Eav\Model\Config $eavConfig, \Magento\Catalog\Block\Product\Context $context, array $data = array(), $attr = null)
    {
        $this->___init();
    ...
    public function _getProductsBasic($catids, $countProduct = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::_getProductsBasic($catids, $countProduct);
        } else {
    ...
    public function _getProductsIDs()
    {
        ...
        if (!$pluginInfo) {
            return parent::_getProductsIDs();
        } else {
            return $this->___callPlugins('_getProductsIDs', func_get_args(), $pluginInfo);
        }
    }
