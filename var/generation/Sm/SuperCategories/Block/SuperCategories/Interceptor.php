...
class Interceptor extends \Sm\SuperCategories\Block\SuperCategories implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListCriterionFilter');
        if (!$pluginInfo) {
            return parent::getListCriterionFilter($filter_catid);
        } else {
            return $this->___callPlugins('getListCriterionFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListCategoriesFilter');
        if (!$pluginInfo) {
            return parent::getListCategoriesFilter($categoryId, $start);
        } else {
            return $this->___callPlugins('getListCategoriesFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function _getProductCatalog()
    {
        ...
        if (!$pluginInfo) {
            return parent::_getProductCatalog();
        } else {
            return $this->___callPlugins('_getProductCatalog', func_get_args(), $pluginInfo);
        }
    }
