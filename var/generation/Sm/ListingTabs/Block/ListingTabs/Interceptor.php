...
class Interceptor extends \Sm\ListingTabs\Block\ListingTabs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\ResourceConnection $resourceConnection, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Catalog\Block\Product\Context $context, \Magento\Eav\Model\Config $eavConfig, array $data = array(), $attr = null)
    {
        $this->___init();
        parent::__construct($resourceConnection, $objectManager, $context, $eavConfig, $data, $attr);
    }
    ...
    public function _isAjax()
    {
        ...
        if (!$pluginInfo) {
            return parent::_isAjax();
        } else {
            return $this->___callPlugins('_isAjax', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function _getSelectSource()
    {
        ...
        if (!$pluginInfo) {
            return parent::_getSelectSource();
        } else {
            return $this->___callPlugins('_getSelectSource', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getCatIds');
        if (!$pluginInfo) {
            return parent::_getCatIds();
        } else {
            return $this->___callPlugins('_getCatIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getCatinfor');
        if (!$pluginInfo) {
            return parent::_getCatinfor($catids, $orderby);
        } else {
            return $this->___callPlugins('_getCatinfor', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_moduleID');
        if (!$pluginInfo) {
            return parent::_moduleID();
        } else {
            return $this->___callPlugins('_moduleID', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getProductInfor');
        if (!$pluginInfo) {
            return parent::_getProductInfor($_catids, $field_order);
        } else {
            return $this->___callPlugins('_getProductInfor', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getCountProductsBasic');
        if (!$pluginInfo) {
            return parent::_getCountProductsBasic($catids, $field_order, $countProduct);
        } else {
            return $this->___callPlugins('_getCountProductsBasic', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function _getProductsBasic($catids, $field_order = null, $countProduct = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::_getProductsBasic($catids, $field_order, $countProduct);
        } else {
            return $this->___callPlugins('_getProductsBasic', func_get_args(), $pluginInfo);
        }
    }
